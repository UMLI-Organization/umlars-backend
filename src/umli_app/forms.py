...
class SignUpForm(UserCreationForm):
    ...
    orcid_id = forms.CharField(max_length=16, label="", widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'ORCID iD'}), required=False, help_text='<span class="form-text text-muted"><small>Optional 16-digit ORCID iD.</small></span>')
