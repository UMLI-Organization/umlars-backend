...
@contextmanager
def create_copies_of_forms_from_formset(request_post: QueryDict, formset_prefix: str, forms_copies_config: Iterator[FormCopiesConfig], last_copy_overwrites_original: bool = True) -> None:
